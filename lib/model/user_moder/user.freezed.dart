...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(login: $login, id: $id, url: $url, type: $type, score: $score, nodeId: $nodeId, avatarUrl: $avatarUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, organizationsUrl: $organizationsUrl, reposUrl: $reposUrl, eventsUrl: $eventsUrl, receivedEventsUrl: $receivedEventsUrl, siteAdmin: $siteAdmin)';
  }
